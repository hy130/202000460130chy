...
if __name__=="__main__":
    ...
    xt1=s.recv(1024)#收到相应的密文
    yt1=s.recv(1024)#收到相应的密文

    xt1=int(xt1.decode(),10)
    yt1=int(yt1.decode(),10)

    xt2,yt2=multi(xt1,yt1,gmpy2.invert(d2,p))

    s.send(str(xt2).encode())#将密文进行发送
    time.sleep(1)#暂停1s
    s.send(str(yt2).encode())
